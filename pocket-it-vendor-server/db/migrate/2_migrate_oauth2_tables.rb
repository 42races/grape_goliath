class MigrateOauth2Tables < ActiveRecord::Migration
  def self.up
    ...
    add_index :oauth2_authorizations, [:oauth2_client_id, :access_token_hash], :name => 'access_token_index'
    add_index :oauth2_authorizations, [:oauth2_client_id, :refresh_token_hash], :name => 'refresh_token_index'
  end
